...
export default function Register() {
  ...
  const handleSocialSignUp = async (provider: Provider) => {
    try {
      ...
      setError(err.message || `Terjadi kesalahan saat mendaftar dengan ${provider}`)
            ...
            <div className="mb-6">
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-slate-800 hover:bg-slate-700 text-white rounded-lg font-medium border border-slate-700 transition-colors flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                >
