                ...
                <div className="mb-auto">
                  ...
                  <div className="flex items-center mb-6">
                    <div className="flex items-center">
                      ...
                      <Link
                        href={`https://wa.me/6282254044783?text=Hai%2C%20saya%20tertarik%20dengan%20source%20code%20${encodeURIComponent(sourceCode.title)}%20karya%20${encodeURIComponent(sourceCode.author.name)}`}
                        target="_blank"
